...
function generateUserAgent() {
    ...
    return $userAgent . random_int(1000000, 9999999); // Ganti rand() dengan mt_rand()
}
...
function generateChatInstance() {
    return strval(random_int(1000000, 9999999)); // Ganti rand() dengan mt_rand()
}
    ...
    foreach ($users as $userId => $userData) {
        ...
        if ($httpCode === 200) {
            ...
            if ($reward) {
                ...
                echo printColored("[ REPORT ] If facing issue again and again Send Details and ScreenShot Contact Developer Telegram @Sayfull_XD\n", $yellow);
                continue;
            }
        } elseif ($httpCode === 403) {
